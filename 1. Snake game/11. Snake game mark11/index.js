...
function oneStep(){
    ...
    if(siStopper>=25){
        ...
        if(snake[6].style.top==String(topp[5])+"px"&&snake[6].style.left==String(left[5])+"px"){
            eleminateTurn()
        }
        ...
        if(path[0].length==0){
            ...
            execute();
            snake[6].style.top=String(topp[0])+"px";
            snake[6].style.left=String(left[0])+"px";
            snake[6].style.display="block";
        }
    }
}
function eleminateTurn(){
    snake[6].style.display="none";
}
